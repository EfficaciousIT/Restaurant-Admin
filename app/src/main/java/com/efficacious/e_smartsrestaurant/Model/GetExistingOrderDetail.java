...
public class GetExistingOrderDetail {
     ...
     * @param id
     * @param categoryName
     * @param vchFoodDescription
     * @param tableName
     */

    public GetExistingOrderDetail(Integer id, String kitchenStatus, Integer orderId, String categoryName, String menuName, Float price, Integer qty, String tableName, Integer employeeId, String fcmToken, String vchFoodDescription, String menuType) {
        this.id = id;
