...
public class LoginForTakeAwayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_for_take_away);
                    ...
                    firebaseFirestore.collection("UserData")
                            ...
                            .addSnapshotListener(new EventListener<QuerySnapshot>() {
                                ...
                                public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                                    if (!value.isEmpty()){
                                        Intent intent = new Intent(LoginForTakeAwayActivity.this, LoginOtpActivity.class);
        ...
        mBtnRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LoginForTakeAwayActivity.this,RegisterActivity.class));
                finish();
            }
        });
    }
