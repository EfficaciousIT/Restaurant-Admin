...
public class ExistingOrderMenuCategoryAdapter extends RecyclerView.Adapter<ExistingOrderMenuCategoryAdapter.ViewHolder>{

    List<MenuCategoryDetail> menuCategoryDetail;
    Context context;

    public ExistingOrderMenuCategoryAdapter(List<MenuCategoryDetail> menuCategoryDetail) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment fragment = new ExistingOrderMenuListFragment();
