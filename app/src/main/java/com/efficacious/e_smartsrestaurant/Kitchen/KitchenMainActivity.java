...
//                        Toast.makeText(MainActivity.this, token, Toast.LENGTH_SHORT).show();
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()){
                    case R.id.newOrder:
                        selectFragment = new KitchenHomeFragment();
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new KitchenHomeFragment()).commit();
    ...
    private void logout() {
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                startActivity(new Intent(KitchenMainActivity.this, SplashScreenActivity.class));
                finish();
            }
        });
